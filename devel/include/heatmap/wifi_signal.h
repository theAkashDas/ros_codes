...
bool operator==(const ::heatmap::wifi_signal_<ContainerAllocator1> & lhs, const ::heatmap::wifi_signal_<ContainerAllocator2> & rhs)
{
  return lhs.essid == rhs.essid &&
    lhs.link_quality == rhs.link_quality &&
    lhs.link_quality_max == rhs.link_quality_max &&
