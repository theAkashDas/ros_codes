...
bool operator==(const ::heatmap::interpolation_serviceRequest_<ContainerAllocator1> & lhs, const ::heatmap::interpolation_serviceRequest_<ContainerAllocator2> & rhs)
{
  return lhs.spacing == rhs.spacing &&
    lhs.shepard_power == rhs.shepard_power;
}
