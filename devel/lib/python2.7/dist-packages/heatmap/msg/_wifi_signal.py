...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2Bi().pack(_x.link_quality, _x.link_quality_max, _x.bitrate))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.link_quality, _x.link_quality_max, _x.bitrate,) = _get_struct_2Bi().unpack(str[start:end])
      return self
